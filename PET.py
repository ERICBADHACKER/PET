...
#AUTHOR : CHIGOZIEWORLDWIDE (PET)
#OPEN SOURCE :)
#DON'T FORGET TO GIVE CREDIT TO PET
...
header = {"user-agent": '[Mozilla/5.0 (Windows; U; Windows NT 6.0; hu-HU) AppleWebKit/533.19.4 (KHTML, like Gecko) Version/5.0.3 Safari/533.19.4;]',
